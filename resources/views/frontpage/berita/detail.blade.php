        ...
        <div class="blog-details-content p_relative d_block mr_20">
            <div class="blog-post p_relative d_block mb_60">
                <div class="content-one p_relative d_block mb_60">
                    <h3 class="d_block fs_30 lh_30 mb_5">{{$berita->judul}}</h3>
                    <p class="text d_iblock float_left fs_16 font_family_poppins">{{date("d M Y",strtotime($berita->created_at))}}</p><br>
                    <p class="text d_iblock float_left fs_16 font_family_poppins">Penulis : </p><span class="text d_iblock float_left fs_16 font_family_poppins">{{$berita->user->name}}</span>
    ...
    <div class="auto-container" style="max-width: 1200px;">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 news-block" style="">
                <div class="news-block" style="border: 0.5px solid; border-radius: 10px; padding: 20px; border-color: gray;">
                    <div class="news-block-one wow fadeInUp animated animated animated" data-wow-delay="00ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;">
                        <div class="inner-box p_relative d_block mb_20">
                            ...
                            <div class="lower-content p_relative d_block pt_25">
                                <h4 class="d_block fs_20 lh_30 mb_6"><a href="blog-details.html">{{Str::limit($berita->judul,75)}}</a></h4>
