        ...
        <div class="slide-item p_relative">
            ...
            <div class="auto-container">
                <div class="content-box p_relative d_block z_5">
                    <h2 class="p_relative d_iblock fw_bold fs_80 lh_90 mb_15 font_family_oxygen"><span class="slider-text-anim">{{$slider->judul}}</span></h2>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="auto-container">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 news-block mt_10">
    ...
    <div class="auto-container" style="max-width: 1200px;">
        <div class="row clearfix">
            ...
            <div class="col-lg-8 col-sm-8">
                <iframe src="http://e-siginjeimuseum.online/" frameborder="0" width="100%" style="height: 500px; border-radius: 10px;"></iframe>
            </div>
        </div>
    </div>
</section>
